...
parent: /it/fforde
layout: it_doc
description: Describes the steps necessary to install, configure, and run Microsoft Office on fforde.
---

This {% collection_doc_link /it/fforde baseurl:true %} sub-guide describes the steps necessary to install, configure, and run Microsoft Office 2010 on fforde.
