...
image: "/assets/images/2019-04-25-personal-devops-hamster.png"
...
<img alt="Photo of person carrying large stack of boxes." src="{{ '/assets/images/2019-04-25-personal-devops-carrying-boxes.jpg' | prepend: site.baseurl }}" style="border: 1px solid black" width="300px" />
...
![Screenshot of wiki page with backlog and current day's tasks.]({{ '/assets/images/2019-04-25-personal-devops-daily-log.png' | prepend: site.baseurl }})
...
<img alt="Application icons for Mail, Google Calendar, and Slack, with badges indicating lots of unreads." src="{{ '/assets/images/2019-04-25-personal-devops-notifications.svg' | prepend: site.baseurl }}" style="padding: 5px; border: 1px solid black" width="250px" />
...
<img alt="Screenshot of calendar day with most time reserved for heads-down work." src="{{ '/assets/images/2019-04-25-personal-devops-calendar.png' | prepend: site.baseurl }}" style="padding: 5px; border: 1px solid black" width="400px" />
...
<img alt="Screenshot of daily log page in wiki. Question: calendar t can I do today that will still matter a year from? Answer: Move TICKET-12345 along: that will really help our customers!" src="{{ '/assets/images/2019-04-25-personal-devops-daily-log-with-goal.png' | prepend: site.baseurl }}" />
...
<img alt="Photo of hamster running in exercise wheel. Very cute!" src="{{ '/assets/images/2019-04-25-personal-devops-hamster.png' | prepend: site.baseurl }}" style="border: 1px solid black" />
...
<img alt="Screenshot of daily log page in wiki, with work hours logged." src="{{ '/assets/images/2019-04-25-personal-devops-daily-log-with-hours.png' | prepend: site.baseurl }}" />
...
<img alt="RescueTime logo." src="{{ '/assets/images/2019-04-25-personal-devops-rescuetime-logo.svg' | prepend: site.baseurl }}" style="padding: 5px; border: 1px solid black" width="300px" />
...
<img alt="Woman wearing boxing gloves punching man in face." src="{{ '/assets/images/2019-04-25-personal-devops-punch.jpg' | prepend: site.baseurl }}" style="border: 1px solid black" width="400px" />
...
<img alt="Cheesy photo of four people around a table doing a group high five." src="{{ '/assets/images/2019-04-25-personal-devops-team-high-five.jpg' | prepend: site.baseurl }}" style="border: 1px solid black" width="400px" />
...
<img alt="Photo of seaside cliff with sign: Unstable cliffs. Danger. Stay back. No public access." src="{{ '/assets/images/2019-04-25-personal-devops-cliff.jpg' | prepend: site.baseurl }}" style="border: 1px solid black" width="400px" />
...
<img alt="Photo of person faced-down in bed with just their feet showing from under the covers." src="{{ '/assets/images/2019-04-25-personal-devops-sleep.jpg' | prepend: site.baseurl }}" style="border: 1px solid black" width="400px" />
